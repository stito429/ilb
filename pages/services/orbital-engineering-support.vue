  ...
  <section>
    ...
    <footer class="footer hero-bg">
      <div class="content colummns">
        ...
        <div class="is-size-4 has-text-white column is-offset-1 is-5">{{footerPublish}}</div>
      </div>
    </footer>
  </section>
</template>
...
export default {
  ...
  data: function() {
    return {
      header: "Orbital Engineering Support",
...
hr {
  border: 1px solid rgb(143, 134, 38);
  border-radius: 2px;
}
.logo-color {
  color: rgb(143, 134, 38);
